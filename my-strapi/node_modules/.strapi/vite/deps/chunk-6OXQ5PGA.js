import {
  ...
  StageColumn,
  getDisplayName
} from "./chunk-3TZRTAX5.js";
import {
  buildValidParams as buildValidParams2
} from "./chunk-AK5CFNWL.js";
import {
  getStageColorByHex
} from "./chunk-H7I72UVD.js";
import {
  LimitsModal
} from "./chunk-7NSM5QYP.js";
import {
...
} from "./chunk-MYMDLUXK.js";
import {
  useTypedSelector
} from "./chunk-RZNJMLBG.js";
import {
  ...
  useGetLocalesQuery,
  useGetSettingsQuery
} from "./chunk-USOPJJ55.js";
import {
  ReleaseActionMenu,
  ReleaseActionOptions
} from "./chunk-ZKDGXZDI.js";
import {
  index
} from "./chunk-PGCM4JR3.js";
import {
...
import {
  ...
  usePersistentState,
  useSelectionState
} from "./chunk-7KLUXS6G.js";
import {
  useConfig
} from "./chunk-4OYECUFS.js";
import {
  Primitive,
  abortUpload,
  cancelUpload,
...
import {
  useDocumentActions
} from "./chunk-K6CB5WKF.js";
import {
  buildValidParams,
  useContentManagerContext,
  useDocument,
  useDocumentLayout
} from "./chunk-UAEFRJGF.js";
import {
  renderAdmin
...
import {
  useLicenseLimits
} from "./chunk-E3IZ2EHA.js";
import {
  Table,
  useTable
} from "./chunk-SBLBS6WJ.js";
import {
  useField,
  useForm
...
var index2 = {
  register(app) {
    ...
    app.addMenuLink({
      ...
      Component: () => import("./App-K5W36FCI.js"),
      position: 5
    });
    app.registerPlugin({
      id: pluginId,
  ...
  register(app) {
    app.createSettingSection({
    ...
    }, [
      {
        ...
        id: "settings",
        to: "email",
        Component: () => import("./Settings-XA776OKF.js").then((mod) => ({
...
var admin2 = {
  register(app) {
    app.addMenuLink({
      ...
      Component: () => {
        return import("./App-7AG77QC7.js").then((mod) => ({
          default: mod.Upload
        }));
      },
      position: 4
    ...
    if (window.strapi.future.isEnabled("unstableMediaLibrary")) {
      ...
      app.addMenuLink({
        ...
        permissions: PERMISSIONS3.main,
        Component: () => {
          return import("./App-MRND46TQ.js").then((mod) => ({
    ...
    app.addSettingsLink("global", {
      ...
      async Component() {
        const { ProtectedSettingsPage } = await import("./SettingsPage-ED53IRMC.js");
        return {
...
var index3 = {
  ...
  bootstrap(app) {
    ...
    app.addSettingsLink("global", {
      ...
      Component: () => import("./SettingsPage-JOWLFUH2.js").then((mod) => ({
        default: mod.ProtectedSettingsPage
      })),
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled("cms-content-releases")) {
      app.addMenuLink({
        ...
        Component: () => import("./App-TXOPLBQV.js").then((mod) => ({
          default: mod.App
        })),
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { ProtectedReleasesSettingsPage } = await import("./ReleasesSettingsPage-I65STOVN.js");
          return {
      ...
      app.widgets.register([
        {
          ...
          component: async () => {
            const { UpcomingReleasesWidget } = await import("./Widgets-KC23S6AJ.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseContentReleases } = await import("./PurchaseContentReleases-5DSJLIYY.js");
          return {
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled(FEATURE_ID)) {
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { Router } = await import("./router-ASJ6BIFC.js");
          return {
            default: Router
          };
        }
      ...
      app.widgets.register((widgets) => [
        ...widgets,
        {
          ...
          component: async () => {
            const { AssignedWidget } = await import("./Widgets-OR65B7IO.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseReviewWorkflows } = await import("./purchase-review-workflows-7ENZALX6.js");
          return {
...
//# sourceMappingURL=chunk-6OXQ5PGA.js.map
