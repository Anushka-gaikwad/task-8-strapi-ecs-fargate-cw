import {
  ...
  HOOKS
} from "./chunk-G25ZBVS4.js";
import {
  useNpsSurveySettings
} from "./chunk-ICLAELDK.js";
import {
  GuidedTourContext,
  useAIAvailability
} from "./chunk-LRCWPE3E.js";
import {
  useGetAIUsageQuery
} from "./chunk-MWJJTIF6.js";
import {
  require_pick
} from "./chunk-XKWSD44K.js";
import {
  getBasename
} from "./chunk-QIJGNK42.js";
import {
  useClipboard
} from "./chunk-47YYBUWX.js";
import {
  useEnterprise
} from "./chunk-FFPVSXHK.js";
import {
  ADMIN_PERMISSIONS_EE,
  AUDIT_LOGS_DEFAULT_PAGE_SIZE,
  getEERoutes
} from "./chunk-BPXTY5DD.js";
import {
  Login
} from "./chunk-PF2QWXPX.js";
import {
  MemoizedInputRenderer
} from "./chunk-ZYJF4E57.js";
import {
  Form
} from "./chunk-XTOCPAJL.js";
import {
  Column,
  LayoutContent,
  Logo,
  UnauthenticatedLayout
} from "./chunk-JGOTUCHJ.js";
import {
  ConfigurationProvider
} from "./chunk-APLB3XCD.js";
import {
  _setPrototypeOf
...
import {
  ...
  require_merge,
  require_omit
} from "./chunk-YJDB6VBH.js";
import {
  require_baseRest
} from "./chunk-L3PYYXAP.js";
import {
  HistoryProvider
} from "./chunk-AGY3A2SB.js";
import {
  errorsTrads
...
import {
  ...
  create4 as create2,
  create6 as create3
} from "./chunk-BWDWFKQ6.js";
import {
  Layouts
} from "./chunk-FPQ7F6IK.js";
import {
  TrackingProvider,
  useTracking
} from "./chunk-W7EQFNCR.js";
import {
  createAbsoluteUrl,
  useInitQuery
} from "./chunk-SDOIYEAY.js";
import {
  getByteSize
...
} from "./chunk-FTAA7RYG.js";
import {
  useTypedDispatch,
  useTypedSelector,
  useTypedStore
} from "./chunk-GFZWG3Q3.js";
import {
  NotificationsProvider,
  useNotification
} from "./chunk-B66PFXKY.js";
import {
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.AUDIT_LOGS) ? [
    {
      path: "audit-logs",
      lazy: async () => {
        const { ProtectedListPage } = await import("./ListPage-MF3ENZNZ.js");
        return {
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.SSO) ? [
    {
      path: "single-sign-on",
      lazy: async () => {
        const { ProtectedSSO } = await import("./SingleSignOnPage-AJPF4KHZ.js");
        return {
...
var AuthPage = () => {
  ...
  const { hasAdmin } = data ?? {};
  const Login$1 = useEnterprise(Login, async () => (await import("./Login-6LOIEMPU.js")).LoginEE);
  const forms = useEnterprise(FORMS, async () => (await import("./constants-H54EF55J.js")).FORMS, {
...
var ROUTES_CE = [
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-XVRWQHKL.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import("./CreatePage-HK73OOMZ.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-RNKEQOIW.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-EOUITOJU.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-LPZNCGS5.js");
      return {
        Component: ProtectedEditPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import("./CreatePage-BFKHED6O.js");
      return {
        Component: ProtectedCreatePage
      };
    },
  ...
  {
    lazy: async () => {
      const editWebhook = await import("./EditPage-H22BWQCV.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-Z4HFYNNB.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-ED2QXFWG.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-5G34KOWN.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditViewPage-U6SMA3D3.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-47EU5HIJ.js");
      return {
        Component: ProtectedCreateView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-ZKUTZ7I2.js");
      return {
        Component: ProtectedListView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditView-F2J7NMM6.js");
      return {
        Component: ProtectedEditView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedInstalledPlugins } = await import("./InstalledPlugins-RBS4RW66.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseAuditLogs } = await import("./PurchaseAuditLogs-5RZFU2WK.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseSingleSignOn } = await import("./PurchaseSingleSignOn-U3TIBLNJ.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseContentHistory } = await import("./PurchaseContentHistory-J2IQPW6F.js");
      return {
...
var getImmutableRoutes = () => [
  {
    path: "usecase",
    lazy: async () => {
      const { PrivateUseCasePage } = await import("./UseCasePage-BJJUPUIP.js");
      return {
...
var getInitialRoutes = () => [
  {
    index: true,
    lazy: async () => {
      const { HomePage } = await import("./HomePage-2V47VXWY.js");
      return {
        Component: HomePage
      };
    }
  },
  {
    path: "me",
    lazy: async () => {
      const { ProfilePage } = await import("./ProfilePage-FGWXFYTP.js");
      return {
  ...
  },
  {
    path: "settings/*",
    lazy: async () => {
      const { Layout } = await import("./Layout-GCA6X2YA.js");
      return {
        Component: Layout
      };
    },
    children: [
      {
        ...
        lazy: async () => {
          const { ApplicationInfoPage } = await import("./ApplicationInfoPage-QOJR3PAS.js");
          return {
    ...
    const routes = [
      {
        ...
        children: [
          ...getImmutableRoutes(),
          {
            path: "/*",
            lazy: async () => {
              const { PrivateAdminLayout } = await import("./AuthenticatedLayout-SFEAHRDH.js");
              return {
    ...
    this.widgets.register([
      {
        ...
        component: async () => {
          const { ProfileWidget } = await import("./Widgets-JPWDLVY2.js");
      ...
      },
      {
        ...
        component: async () => {
          const { KeyStatisticsWidget } = await import("./Widgets-JPWDLVY2.js");
      ...
      this.widgets.register([
        {
          ...
          component: async () => {
            const { AuditLogsWidget } = await import("./Widgets-HGCCGML6.js");
...
//# sourceMappingURL=chunk-RIHZ6CVV.js.map
